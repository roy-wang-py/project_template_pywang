...
#else
static const char* kDefaultLogFile                         =      "/tmp/myeasylog.log";
...
void Configurations::setToDefault(void) {
  ...
  setGlobally(ConfigurationType::Filename, std::string(base::consts::kDefaultLogFile), false);
  ...
  setGlobally(ConfigurationType::Format, std::string("%datetime %levshort | %msg"), true);
  set(Level::Debug, ConfigurationType::Format,
      std::string("%datetime %levshort | %msg"));

  // std::string("%datetime %level [%logger] [%user@%host] [%func] [%loc] %msg"));

  // INFO and WARNING are set to default by Level::Global
  set(Level::Error, ConfigurationType::Format, std::string("%datetime %levshort | %msg"));
  set(Level::Fatal, ConfigurationType::Format, std::string("%datetime %levshort | %msg"));
  set(Level::Verbose, ConfigurationType::Format, std::string("%datetime %levshort-%vlevel %msg"));
  set(Level::Trace, ConfigurationType::Format, std::string("%datetime %levshort | %msg"));
}
